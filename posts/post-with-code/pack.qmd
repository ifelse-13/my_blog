...
olympicsWeather::get_forecast("Stade de france")|> print(n=10)
```

### Tahiti

```{r warning=FALSE,message=FALSE}
olympicsWeather::get_forecast("Tahiti") |> print(n=10)
...
```{r warning=FALSE,message=FALSE}
olympicsWeather::get_forecast(c(43.276703,5.334791))|> print(n=10)
```
